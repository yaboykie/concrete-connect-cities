...
const ErrorView: React.FC<ErrorViewProps> = ({ error, details, onRetry }) => {
  return (
    <div className="min-h-screen flex flex-col">
      <Header />
      <main className="flex-grow container mx-auto px-4 py-16 text-center">
        <h1 className="text-2xl font-bold mb-4">Something went wrong</h1>
        <p className="text-gray-600 mb-4">{error || "Could not load location data."}</p>
        {details && <p className="text-gray-500 mb-8">{details}</p>}
        <div className="mb-8">
